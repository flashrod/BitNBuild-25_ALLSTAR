  ...
  return (
    <main className="overflow-hidden bg-white">
      <div
        ...
        <div className="w-140 h-320 -translate-y-87.5 absolute left-0 top-0 -rotate-45 rounded-full bg-gradient-to-r from-blue-50 to-indigo-50 opacity-30" />
        <div className="h-320 absolute left-0 top-0 w-60 -rotate-45 rounded-full bg-gradient-to-r from-blue-100 to-indigo-100 opacity-20" />
        <div className="h-320 -translate-y-87.5 absolute left-0 top-0 w-60 -rotate-45 bg-gradient-to-r from-blue-200 to-indigo-200 opacity-10" />
      </div>
          ...
          <div className="mx-auto max-w-5xl px-6">
            <div className="sm:mx-auto lg:mr-auto lg:mt-0">
              ...
              <TextEffect
                ...
                delay={0.5}
                as="p"
                className="mt-8 max-w-2xl text-pretty text-lg text-gray-600 font-inter">
